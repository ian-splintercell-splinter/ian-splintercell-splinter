<?php
  ...
  session_start();
  do_html_header("Welcome to Splinters Floor Central Shopping Cart");
...
<div class="header">
	<div id="menu-container">	
		<ul id="drop_down_menu">
			<li class="menu">Add a Product
				<ul class="links">
					<li><a href="http://splintercellpro.com/splintercellpr/MyProducts/new_product_sample.html">New 
            Product</a></li>

						<li><a href="http://splintercellpro.com/splintercellpr/MyProducts/search_samples.html">Search for a Product 
             </a></li>
        ...
        <ul class="links">
			...
			<li class="menu">Online Shop & Admin 
        <ul class="links">
          <li><a href="http://splintercellpro.com/splintercellpr/Chapter%2029/">Online Product Store</a></li>
          <li><a href="http://splintercellpro.com/splintercellpr/Chapter%2029/login.php">Admin 
            Section for Product.</a></li>
        </ul>
      </li>			
      <li class="menu">Tecnical Users Forum 
              <ul class="links">
          <li><a href="http://splintercellpro.com/PHPMYSQLChapters/Chapter%2032/index.php?collapse=all">Forum</a></li>
        </ul>
      </li>
      			<li class="menu">About me 
        <ul class="links">
          <li><a href="http://splintercellpro.com/dir/contact-me/">Contact me 
            on My Blog</a></li>
          <li><a href="http://splintercellpro.com/PHPMYSQLChapters/Chapter%2030/">Contact 
            me on Warm Mail.</a></li>
          <li><a href="http://splintercellpro.com/dir/wp-content/uploads/2015/02/Ian-Hyndman-CV-Final-IT-Long2.pdf">MyCV.pdf</a></li>
        </ul>
      </li>
      		</ul>
	</div>
</div>
<p><font size="-1"><dfn><font color="#999999">Magento, Woo Commerce, Bitnami are good free e-commerce sites which offer extra cart functionality to sell products online. If this suits your site there is plenty of third party software available to get your business running online. Using third party software, much of the work has been done for you using their templates and if needed auto-executable installers. 

 

This example shopping cart is managed without the use of any templates .
